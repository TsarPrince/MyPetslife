    ...
    <div>
      <div className='sm:grid sm:grid-cols-2'>
        ...
        <div className='snap-start snap-always bg-[#DDE9FF] h-screen sm:h-auto flex justify-center'>
          <div className='max-w-xl p-6 px-0 sm:py-28 space-y-16 flex flex-col'>
            <div className='flex flex-col items-center text-center space-y-4'>
              <p className='font-josefin-sans text-3xl sm:text-4xl font-bold text-blue-600 px-4'>Share your pet&apos;s precious moments!!</p>
        ...
        <div className='snap-start snap-always bg-[#D6FEFF] h-screen sm:h-auto flex justify-center'>
          <div className='max-w-xl p-6 sm:py-28 flex flex-col'>
            <div className='flex flex-col items-center text-center space-y-4'>
        ...
        <div className='snap-start snap-always bg-[#fff] h-screen sm:h-auto flex justify-center'>
          <div className='max-w-xl p-6 px-0 sm:py-28 flex flex-col'>
            <div className='flex flex-col items-center text-center space-y-4'>
              <p className='font-josefin-sans tracking-tight leading-tight text-3xl sm:text-4xl font-bold text-purple-600 px-4'>Join community of pet lovers!</p>
