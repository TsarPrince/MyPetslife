      ...
      <div className='relative max-h-screen overflow-y-scroll sm:max-h-[none] sm:overflow-y-auto snap-y snap-mandatory sm:grid sm:grid-cols-2'>
        ...
        <div className='snap-start snap-always bg-[#DDE9FF] h-screen sm:h-auto flex justify-center'>
          <div className='max-w-xl p-6 px-0 sm:py-28 space-y-16 flex flex-col'>
            ...
            <div id='calculateHeight' className='grow'>
        ...
        <div className='snap-start snap-always bg-[#fff] h-screen sm:h-auto flex justify-center'>
          <div className='max-w-xl p-6 px-0 sm:py-28 space-y-16 flex flex-col'>
            <div className='flex flex-col items-center text-center space-y-4'>
              <p className='text-2xl sm:text-3xl font-bold text-purple-600 px-4'>Join community of pet lovers!</p>
              <p className='sm:text-lg font-semibold text-purple-500 px-4'>With one of the largest Pet community, we have answers to all your problems. These people are same as you, animal lovers</p>
            </div>
            <div className='grow'>
